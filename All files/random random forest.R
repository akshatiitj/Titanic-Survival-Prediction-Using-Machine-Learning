#Modify the directory based on your system
setwd("C:/Users/Me!/Downloads/Titanic data/")
...
library(party)
fit<-cforest(Survived~FamilyId2+CabinPos+Deck+Pclass+Sex+Age+SibSp+Parch+Fare+Embarked+Title+Mother+Child+Deck,data=train,controls=cforest_unbiased(ntree=20000, mtry=3))
